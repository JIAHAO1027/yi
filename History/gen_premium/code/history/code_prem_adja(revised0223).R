...
setwd("../output")
write.csv(result3,file = "numofacc_and_premium_700D_adjacent_0223.csv")
...
hist(result2$prem_adjacent,main="histogram of prem_adjacent",xlab="prem_adjacent",breaks=20)
dev.off()
