...
setwd("../output")
write.csv(result3,file = "numofacc_and_premium_700D_prem_minus_a_0222.csv")

setwd("./graph")
png(file="histogram of prem rel 1 minus a.png",bg="transparent")
hist(result3$premium_minus_a,breaks=1)
dev.off()
png(file="histogram of prem rel 1 minus a perc.png",bg="transparent")
hist(result3$premium_minus_a_perc)
dev.off()
png(file="plot- delta_n_minus_a~premium_minus_a.png",bg="transparent")
plot(result3$diff_minus_a,result3$premium_minus_a,title(main="plot: delta_n_minus_a ~ premium_minus_a"),xlab="delta_n_minus_a",ylab="premium_minus_a")
dev.off()
png(file="boxplot- delta_n_minus_a~premium_minus_a.png",bg="transparent")
boxplot(result3$premium_minus_a~result3$diff_minus_a,xlab="delta_n_minus_a",ylab="premium_minus_a",main="premium_minus_a vs. delta_n_minus_a")
dev.off()
...
dev.off()
model=lm(result3$premium_minus_a~result3$diff_minus_a + factor(result3$item_id) -1 )
summary(model)
