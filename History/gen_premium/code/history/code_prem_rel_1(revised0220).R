...
setwd("../output")
write.csv(result3,file = "numofacc_and_premium_700D_premrel1_0220.csv")

setwd("./graph")
#png(file="distribution of price of bundle 0.png",bg="transparent")
#fixme
